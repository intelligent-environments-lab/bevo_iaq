...
def main():
	...
	while True:
		...
		co_count = 0
		for j in range(5):
			print(f'{datetime.datetime.now()} Running SGP30 scan...')
			try:
			...
			print(f'{datetime.datetime.now()} Running TSL2591 scan...')
			try:
			...
			print(f'{datetime.datetime.now()} Running Nitrogen Dioxide scan...')
			...
			print(f'{datetime.datetime.now()} Running Carbon Monoxide scan...')
			co_data_new = CO_scan()
